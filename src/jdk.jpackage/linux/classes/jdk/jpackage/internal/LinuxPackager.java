...
abstract class LinuxPackager<T extends LinuxPackage> {
    ...
    static PackageType defaultPackageType() {
        return Singleton.PACKAGE_TYPE;
    }
    ...
    private static final class Singleton {
        static final PackageType PACKAGE_TYPE;

        static {
            if (isDebian()) {
                PACKAGE_TYPE = StandardPackageType.LINUX_DEB;
            } else {
                PACKAGE_TYPE = StandardPackageType.LINUX_RPM;
            }
        }
