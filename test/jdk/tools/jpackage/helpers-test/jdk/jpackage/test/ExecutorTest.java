...
public class ExecutorTest extends JUnitAdapter {
    ...
    public enum OutputControl {
        ...
        static List<Set<OutputControl>> variants() {
            ...
            variants.add(Set.of());
            variants.addAll(Stream.of(values()).map(Set::of).toList());
            variants.add(Set.of(DUMP, SAVE_ALL));
            variants.add(Set.of(DUMP, SAVE_FIRST_LINE));
            variants.add(Set.of(DUMP, SAVE_ALL, DISCARD_STDOUT));
            variants.add(Set.of(DUMP, SAVE_FIRST_LINE, DISCARD_STDOUT));
            variants.add(Set.of(DUMP, SAVE_ALL, DISCARD_STDERR));
            variants.add(Set.of(DUMP, SAVE_FIRST_LINE, DISCARD_STDERR));
            variants.add(Set.of(DUMP, SAVE_ALL, DISCARD_STDOUT, DISCARD_STDERR));
            variants.add(Set.of(DUMP, SAVE_FIRST_LINE, DISCARD_STDOUT, DISCARD_STDERR));
