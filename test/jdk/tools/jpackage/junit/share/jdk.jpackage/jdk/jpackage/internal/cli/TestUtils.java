...
final class TestUtils {
    ...
    private final static String DEFAULT_EXCEPTION_MESSAGE_FORMAT_STRING = "Option %s: bad substring [%s] in string [%s]";

    private final static OptionValueExceptionFactory<? extends RuntimeException> DEFAULT_EXCEPTION_FACTORY = OptionValueExceptionFactory.build(TestException::new)
