...
public class HelpTest {
    ...
    public void testHelpOption() {
        ...
        assertTrue(StandardOptionValue.HELP.containsIn(cmdline));
    }
    ...
    public void testOptionGroups( ) {
        ...
        final var allCurrentPlatformOptionNames = StandardOptionValue.options().stream().map(Option::getSpec)
                .filter(StandardOptionValue.currentPlatformOption())
