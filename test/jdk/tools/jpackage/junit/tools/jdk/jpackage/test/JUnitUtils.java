...
public final class JUnitUtils {
    ...
    public final static class ExceptionAnalizer {
    ...
    private final static Map<Class<?>, ArrayEqualsAsserter<?>> ARRAY_ASSERTERS = Map.of(
    ...
    private final static ArrayEqualsAsserter<Object[]> OBJECT_ARRAY_ASSERTER = Assertions::assertArrayEquals;
}
